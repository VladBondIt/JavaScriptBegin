...
// Обычная функция меняет контекст this, а стрелочная нет, можно создать переменную для this или привязать функцию bindom,
// что бы решить проблему обычной функции
